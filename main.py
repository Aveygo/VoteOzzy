...
with open("emb_data.json", "r") as f:
    data = json.load(f) # Assumed fetched
...
def closest(parties, user_emb):
    """
    parties == {"party1": numpy embedding1, "party2": numpy embedding2}
    user_emb == numpy embedding
    
    returns list of party names, sorted by cosine distance
    """
